    ...
    return (
        <div>
            ...
            <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100 container mx-auto">
                <p className="text-6xl text-center font-bold ">Register</p>
                ...
                <p className="text-center pb-3">Already have an account ? <Link to='/login' className="text-blue-700 font-bold">Login</Link> </p>
            </div>
        </div>
    );
};
